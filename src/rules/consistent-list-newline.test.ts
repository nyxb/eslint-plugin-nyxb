...
const valids: ValidTestCase[] = [
  ...
  `,
  // https://github.com/nyxb/eslint-plugin-nyxb/issues/11
  `function fn({ foo, bar }: {\nfoo: 'foo'\nbar: 'bar'\n}) {}`,
  {
    code: 'foo(\na, b\n)',
    options: [{ CallExpression: false }],
  },
  // https://github.com/nyxb/eslint-plugin-nyxb/issues/14
  {
    code: $`
      const a = (
        <div>
  ...
  // https://github.com/nyxb/eslint-plugin-nyxb/issues/15
  $`
    ...
    >('/api/todo-list')
  `,
  // https://github.com/nyxb/eslint-plugin-nyxb/issues/16
  {
    code: $`
      function TodoList() {
  ...
  `,
  // https://github.com/nyxb/eslint-plugin-nyxb/issues/19
  $`
    const a = [
      (1),
      (2)
...
const invalid: InvalidTestCase[] = [
  ...
  // https://github.com/nyxb/eslint-plugin-nyxb/issues/18
  {
    code: $`
      export default nyxb({
      },
